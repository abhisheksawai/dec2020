...
public class Dependon5 {
	
	@Test
	public void TC0_PreLogin()
	{
		System.out.println("tcoo pre login");
	}
	...
	@Test(dependsOnMethods= {"TC01_Login","TC0_PreLogin"})
	public void TC02_buymobile()
	{
		System.out.println("TC02_buymobile | buy mobile");
	}
